...
mode="${2:-train}"
MASTER_PORT="${3:-29531}"
EXP_NAME="${4:-statenav_v5_rxr_${stage}}"
CKPT_PATH="${5:-}"
PRED_FILE="${6:-preds.jsonl}"
if [ "$mode" = "infer" ]; then
    shift $(( $# >= 6 ? 6 : $# )) || true
else
    shift $(( $# >= 5 ? 5 : $# )) || true
...
case "$stage" in
    stage1) EXP_CONFIG="run_rxr/v5/statenav_v5_stage1.yaml" ;;
    stage1_no_attn) EXP_CONFIG="run_rxr/v5/statenav_v5_stage1_no_attn.yaml" ;;
    stage1_no_level3) EXP_CONFIG="run_rxr/v5/statenav_v5_stage1_no_level3.yaml" ;;
    stage2) EXP_CONFIG="run_rxr/v5/statenav_v5_stage2.yaml" ;;
    *)
