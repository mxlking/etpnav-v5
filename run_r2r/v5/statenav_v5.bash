...
mode="${2:-train}"
MASTER_PORT="${3:-29521}"
EXP_NAME="${4:-statenav_v5_r2r_${stage}}"
CKPT_PATH="${5:-}"
...
case "$stage" in
    stage1) EXP_CONFIG="run_r2r/v5/statenav_v5_stage1.yaml" ;;
    stage1_no_attn) EXP_CONFIG="run_r2r/v5/statenav_v5_stage1_no_attn.yaml" ;;
    stage1_no_level3) EXP_CONFIG="run_r2r/v5/statenav_v5_stage1_no_level3.yaml" ;;
    stage2) EXP_CONFIG="run_r2r/v5/statenav_v5_stage2.yaml" ;;
    *)
...
echo "CKPT_PATH            = ${CKPT_PATH:-<empty>}"
...
run_ddp() {
    local -a args=("$@")
    "$PYTHON_BIN" -m torch.distributed.launch             --nproc_per_node="$NPROC"             --master_port="$MASTER_PORT"             run.py "${args[@]}"
}
