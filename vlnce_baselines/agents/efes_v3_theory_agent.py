...
class EFESV3TheoryAgent(nn.Module):
    def __init__(
        ...
        self.corrector = TheoryCorrector(
            ...
            gate_eta_init=float(gate_eta_init),
            gate_tau_init=float(gate_tau_init),
    ...
    def from_config(
        ...
        return cls(
            ...
            gate_eta_init=float(getattr(efes_cfg, "gate_eta_init", 0.5)),
            gate_tau_init=float(getattr(efes_cfg, "gate_tau_init", 0.0)),
