...
_C.EFES_V3_THEORY.gate_eta_init = 0.5
_C.EFES_V3_THEORY.gate_tau_init = 0.0
...
def coerce_legacy_scalar_types(config: CN) -> None:
    ...
    config.EFES_V3_THEORY.gate_eta_init = float(getattr(config.EFES_V3_THEORY, "gate_eta_init", 0.5))
    config.EFES_V3_THEORY.gate_tau_init = float(getattr(config.EFES_V3_THEORY, "gate_tau_init", 0.0))
